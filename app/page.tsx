...
const Page = () => {
  return (
    <RowSlide className="">
      ...
      <div className="flex-shrink-0 h-full w-1/2 flex flex-col items-center justify-center px-10 bg-light max-lg:w-full max-lg:py-40">
