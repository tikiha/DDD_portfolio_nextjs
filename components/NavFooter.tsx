...
const NavFooter = () => {
  ...
  return (
    ...
    >
      <Link
        className="flex flex-col items-center bg-dark py-1"
        href={"/contact"}
      >
        <span className="text-light text-sm">お問い合わせ</span>
        <Mail className="w-5 fill-light py-0" />
      </Link>
      <button
      ...
      >
        <ChevronsUp className="stroke-light" />
      </button>
    </div>
  );
};
